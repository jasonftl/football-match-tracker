...
import { Copy, Sparkles, Cloud } from 'lucide-react';

const MatchDataView = ({
  matchData,
  onCopyToClipboard,
  onGenerateAIReport,
  onGenerateWeatherReport,
  showCopied,
  aiEnabled,
  isFullTime,
  isGeneratingAI,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {/* First Row - Copy, AI Report, Weather Report */}
        <div className="grid grid-cols-3 gap-2">
          ...
          >
            <Sparkles size={20} />
            {isGeneratingAI ? 'AI...' : 'AI Report'}
          </button>

          {/* Weather Report Button */}
          <button
            onClick={onGenerateWeatherReport}
          ...
          >
            <Cloud size={20} />
            {isGeneratingWeather ? 'Weather...' : 'Weather'}
          </button>
        </div>
